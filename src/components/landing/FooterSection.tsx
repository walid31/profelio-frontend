      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-gray-400 mb-4">
            Professional templates for experts, consultants, and creatives.
          </p>
        ...
        <div>
          ...
          <p className="text-gray-400 mb-4">Have questions? Chat with us on WhatsApp or email hello@profelio.com.</p>
        </div>
      </div>
      <div className="mt-8 pt-8 border-t border-gray-800 text-center">
        <p className="text-gray-400 text-sm">© 2025 Profelio. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
