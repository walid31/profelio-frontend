        ...
        {options.map((opt) => {
          ...
          return (
            <div
              ...
              className="flex items-center space-x-2 cursor-pointer px-2 py-1 rounded hover:bg-accent"
            >
              <div
                className={cn(
                  "h-4 w-4 border border-muted rounded-sm flex items-center justify-center",
